...
const Contents = () => {
  return <main className="py-4 pl-4 h-[500px] overflow-auto order-1 sm:order-2">
    <section className="h-full flex flex-col items-center justify-center gap-1">
      <svg
        ...
        <p className="font-medium text-text-secondary">Fill in the form and type generate</p>
    </section>
  </main>;
};
